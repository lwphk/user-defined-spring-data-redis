...
public class JedisLock {
    ...
    public static final int DEFAULT_EXPIRY_TIME_MILLIS = 2 * ONE_SECOND;
    public static final int DEFAULT_ACQUIRE_TIMEOUT_MILLIS = 1 * ONE_SECOND;
    public static final int DEFAULT_ACQUIRY_RESOLUTION_MILLIS = 50;
     ...
     * @param lockKey
     *            lock key (ex. account:1, ...)
     * @param acquireTimeoutMillis   获取锁超时时间
     *            acquire timeout in miliseconds (default: 10000 msecs)
     * @param expiryTimeMillis    锁时间
